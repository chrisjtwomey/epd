...
from epd_server import DisplayServer, FirmwareSettings, Page, StaticSource
...
DisplayServer(
    ...
    # Offer the newest firmware/<version>.bin to every panel named my-display
    # whose version differs from it.
    firmware=FirmwareSettings(enabled=True, dir="firmware", product="my-display",
